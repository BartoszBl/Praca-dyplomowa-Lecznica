...
namespace Lecznica.Controllers
{
    public class StoreroomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nazwa_produktu,Ilość")] Storeroom storeroom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nazwa_produktu,Ilość")] Storeroom storeroom)
        {
            if (ModelState.IsValid)
            {
